...
export default function NewsletterSection() {
  ...
  return (
    <motion.div
      ...
      className="flex flex-col items-center mb-20 px-4"
    >
      {/* Logo con animación */}
      <motion.div
        initial={{ scale: 0 }}
        ...
        >
          <div className="relative flex-1 max-w-xs mx-auto sm:mx-0">
            ...
            <Input
              ...
              className="w-full pl-11 pr-4 py-6 rounded-lg bg-gray-900/50 text-gray-200 border border-gray-800 focus:border-[#F8C8DC] transition-all backdrop-blur-sm"
              required
            />
          </div>
          ...
          <Button
            type="submit"
            disabled={isLoading || isSubmitted}
            className="px-8 py-6 rounded-lg bg-gradient-to-r from-[#F8C8DC] to-[#D3B5E5] text-gray-900 font-semibold hover:shadow-lg hover:shadow-[#F8C8DC]/20 transition-all disabled:opacity-50"
          >
            {isSubmitted ? (
              <motion.span
                initial={{ scale: 0 }}

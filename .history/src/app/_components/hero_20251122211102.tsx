...
export const Hero = () => {
  ...
  return (
    <motion.section
      ...
      className="relative md:min-h-screen flex flex-col-reverse lg:flex-row items-center justify-center lg:gap-20 overflow-hidden bg-gradient-to-br from-[#BEE8CC]/10 via-[#FEFCF9]/60 to-[#FDE68A]/20"
    >
      {/* Texto principal */}

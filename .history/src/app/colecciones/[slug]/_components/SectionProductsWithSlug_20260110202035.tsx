  ...
  return (
    <section className="container mx-auto px-0 md:px-6 lg:px-20 min-h-screen">
      ...
      {sortedProducts.length > 0 ? (
        <section className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 w-full px-0 md:px-6 lg:px-20 items-start">
            ...
            return (
              ...
              >
                <Card className="h-full">
                  {/* Imagen del producto */}
                  <div className="relative h-48 sm:h-56 w-full overflow-hidden bg-muted flex-shrink-0">
                    <Image

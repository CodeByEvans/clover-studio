          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              <div className="flex flex-col sm:flex-row gap-3 max-w-md">
                ...
                />
                <button className="group relative inline-flex w-full sm:w-auto cursor-pointer">
                  {/* Efecto de brillo detrás del botón, ahora con el color verde */}
                  <div className="absolute inset-0 bg-[#39a459] rounded-full blur opacity-75 group-hover:opacity-100 transition-opacity duration-300 w-2000"></div>

      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center">
            ...
            >
              <SelectTrigger className="w-[180px]  rounded-r-none bg-gray-50 ">
            ...
            <InputGroup className=" max-w-2xl hidden md:flex rounded-l-none">
              <InputGroupInput placeholder="Buscar el Cloverstudio..." />

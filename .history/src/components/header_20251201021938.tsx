      ...
      <section className="container mx-auto">
        ...
        <div className="hidden md:flex items-center justify-between h-20">
          ...
          <div className="flex  items-center max-w-xl w-full">
            <InputGroup className="hidden md:flex rounded-l-none overflow-hidden text-xl">
              <Select
                value={selectedCollection}
                onValueChange={setSelectedCollection}
              >
                <SelectTrigger className="w-[180px] rounded-r-none bg-gray-100 text-gray-700 font-light text-md hidden md:flex">

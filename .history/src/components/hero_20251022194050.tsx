...
export default function Hero() {
  ...
  const handleSuscribe = async () => {
    try {
      await sendWelcomeDiscountEmail(email);
      showSuccess(
        "¡Bienvenido!",
        "Tu correo ha sido registrado correctamente."
      );
    } catch (error) {
      showError("Error", "Hubo un problema al registrar tu correo.");
    }
  };
      ...
      <div className="container mx-auto px-4 min-h-screen flex items-center relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center w-full">
          ...
          <div className="space-y-8">
            ...
            {/* Título principal */}
            <div>
              <h1 className="text-5xl md:text-6xl xl:text-5xl 2xl:text-7xl font-bold text-gray-900 leading-tight mb-6">
            ...
            {/* Descripción */}
            <p className="text-xl md:text-xl xl:text-xl 2xl:text-2xl text-gray-600 leading-relaxed max-w-lg">
            ...
            <div className="space-y-4">
              <div className="flex flex-col sm:flex-row gap-3 max-w-2xl">
                ...
                />
                <button
                  className="group relative inline-flex w-"
                ...
                >
                  ...
                  <div className="relative bg-[#39a459] hover:bg-[#2d8446] text-white px-8 py-4 rounded-full font-semibold text-lg transition-all duration-300 shadow-xl transform group-hover:-translate-y-1 group-hover:scale-105 flex items-center justify-center gap-2 cursor-pointer">
            ...
            <div>
              <button
                onClick={() => handleScrollToId("sobre-nosotros")}
              ...
              <div className="relative bg-white rounded-3xl shadow-2xl p-8 group-hover:shadow-3xl transition-all duration-500 border border-gray-100">
                ...
                <div className="aspect-square bg-gradient-to-br from-[#FEFCF9] to-[#F9F7F3] rounded-2xl flex items-center justify-center relative overflow-hidden">
                  ...
                  <div className="absolute inset-4 grid grid-cols-2 gap-4">
                    {/* Vela 1 - Verde Clover */}
                    <div className="bg-gradient-to-b from-[#309551] to-[#246B3D] rounded-full overflow-hidden shadow-lg transform rotate-3 hover:rotate-6 transition-transform duration-500">
                      <img
                        src="/banner-1.webp"
                        alt="Vela Verde"
                    ...
                    <div className="bg-gradient-to-b from-[#F59E0B] to-[#D97706] rounded-full overflow-hidden shadow-lg transform -rotate-2 hover:-rotate-6 transition-transform duration-500">
                      <img
                        src="/banner-2.webp"
                        alt="Vela Amarilla"
                        className="object-cover w-full h-full"
                    ...
                    {/* Vela 3 - Rojo cálido */}
                    <div className="bg-gradient-to-b from-[#DC2626] to-[#B91C1C] rounded-full overflow-hidden shadow-lg transform rotate-1 hover:rotate-4 transition-transform duration-500">
                      <img
                        src="/banner-3.webp"
                        alt="Vela Roja"
                        className="object-cover w-full h-full"
                    ...
                    {/* Vela 4 - Verde claro */}
                    <div className="bg-gradient-to-b from-[#4ADE80] to-[#309551] rounded-full overflow-hidden shadow-lg transform -rotate-3 hover:-rotate-6 transition-transform duration-500">
                      <img
                        src="/banner-4.webp"
                        alt="Vela Verde Claro"
                        className="object-cover w-full h-full"
                        loading="lazy"
                      />
                    </div>

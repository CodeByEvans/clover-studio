...
export const Hero = ({ products }: HeroProps) => {
  ...
  return (
    <section className="min-h-screen bg-gradient-to-br from-[#BEE8CC]/5 via-[#FEFCF9] to-[#FDE68A]/8 overflow-hidden relative flex flex-raw items-center justify-center px-8 md:px-12 lg:px-16 xl:px-24 2xl:px-24">

      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center">
            ...
            >
              <SelectTrigger className="w-[140px]  rounded-r-none bg-gray-100 text-gray-700 font-light text-xs ">
            ...
            <InputGroup className=" max-w-xl hidden md:flex rounded-l-none">

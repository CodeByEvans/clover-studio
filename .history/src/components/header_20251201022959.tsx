      ...
      <section className="container mx-auto">
        ...
        {searchTerm && filteredProducts.length > 0 && (
          <>
            ...
            />
            <div className="absolute md:absolute top-[var(--dropdown-top)] left-[var(--dropdown-left)] w-full md:w-auto bg-white shadow-md rounded-md mt-1 max-h-60 overflow-auto z-50">

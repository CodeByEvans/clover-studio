...
function CardFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex items-center justify-between gap-3 border-t border-border bg-card/95 p-4 backdrop-blur-sm transition-all duration-300 max-h-0 overflow-hidden opacity-0 hover:max-h-24 hover:opacity-100",
        className
      )}
      {...props}
    />

...
function CardFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex items-center justify-between gap-3 border-t border-border bg-card/95 p-4 backdrop-blur-sm transition-all duration-300 translate-y-full opacity-0 group-hover:translate-y-0 group-hover:opacity-100",
        className
      )}
      {...props}
    />

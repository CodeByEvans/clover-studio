...
function CardTitle({ className, ...props }: React.ComponentProps<"h3">) {
  return (
    <h3
      ...
      className={cn(
        "text-base sm:text-lg text-center font-semibold leading-tight text-foreground line-clamp-2 py-2",
        className
      )}
      {...props}
    />
...
function CardPrice({
  ...
  return (
    ...
    >
      <span className="text-base sm:text-xl text-muted-foreground" {...props} />
    </div>
  );
}

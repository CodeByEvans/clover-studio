      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center">
            ...
            <InputGroup className=" hidden md:flex-1 w-full rounded-l-none">
              <InputGroupInput
                placeholder="Buscar el Clover Studio..."
                className="rounded-l-none bg-gray-100 text-gray-700 font-light text-xs "
              />
              <Button
                variant="ghost"

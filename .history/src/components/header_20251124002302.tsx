      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center">
            ...
            >
              <SelectTrigger className="w-[180px] border-r-0 rounded-r-none bg-gray-50 hidden md:flex">
            ...
            <InputGroup className=" max-w-2xl hidden md:flex border-l-0 rounded-l-none">

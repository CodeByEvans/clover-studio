...
export const Carousel3D = ({ products }: Carousel3DProps) => {
  ...
  return (
    <div className="relative w-full py-4 md:py-12 overflow-hidden">
      {/* Carousel Container */}
      <div
        className="relative h-[40vh] md:h-[480px] flex items-center justify-center mb-8"
        ...
        <AnimatePresence initial={false}>
          {products.map((product, index) => {
            ...
            return (
              <motion.div
                key={product.title}
                className="absolute w-[220px] h-[260px] md:w-[380px] md:h-[500px] cursor-pointer"
                initial={false}
                animate={{
                  x: position * 420,
      ...
      {isMobile && (
        <Button variant="default" size="sm" className="mx-auto block mb-4">
          Ver colecciones
        </Button>
      )}

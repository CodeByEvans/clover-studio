      ...
      <div className="container mx-auto px-4 min-h-screen flex items-center relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center w-full">
          ...
          <div className="space-y-8">
            ...
            {/* Título principal */}
            <div>
              <h1 className="text-5xl md:text-6xl xl:text-5xl 2xl:text-6xl font-bold text-gray-900 leading-tight mb-6">
            ...
            {/* Descripción */}
            <p className="text-xl md:text-xl text-gray-600 leading-relaxed max-w-lg">

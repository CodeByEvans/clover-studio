              ...
              <div className="relative bg-white rounded-3xl shadow-2xl p-8 group-hover:shadow-3xl transition-all duration-500 border border-gray-100">
                ...
                <div className="aspect-square bg-gradient-to-br from-[#FEFCF9] to-[#F9F7F3] rounded-2xl flex items-center justify-center relative overflow-hidden">
                  ...
                  <div className="absolute inset-4 grid grid-cols-2 gap-4">
                    {/* Vela 1 - Verde Clover */}
                    <div className="bg-gradient-to-b from-[#309551] to-[#246B3D] rounded-full opacity-80 shadow-lg transform rotate-3 hover:rotate-6 transition-transform duration-500">
                      <img
                        src="/banner-1.webp"
                        alt="Vela Verde"
                        className="rounded-xl object-cover w-full h-full transform rotate-3 hover:rotate-6 transition-transform duration-500 shadow-lg overflow-hidden"
                      />
                    </div>
                    {/* Vela 2 - Amarillo cálido */}
                    <div className="bg-gradient-to-b from-[#F59E0B] to-[#D97706] rounded-full opacity-80 shadow-lg transform -rotate-2 hover:-rotate-6 transition-transform duration-500">
                      <img
                        src="/banner-2.webp"
                        alt="Vela Amarilla"
                        className="rounded-xl object-cover w-full h-full transform -rotate-2 hover:-rotate-6 transition-transform duration-500 shadow-lg"
                      />
                    </div>
                    {/* Vela 3 - Rojo cálido */}
                    <div className="bg-gradient-to-b from-[#DC2626] to-[#B91C1C] rounded-full opacity-80 shadow-lg transform rotate-1 hover:rotate-4 transition-transform duration-500">
                      <img
                        src="/banner-3.webp"
                        alt="Vela Roja"
                        className="rounded-xl object-cover w-full h-full transform rotate-1 hover:rotate-4 transition-transform duration-500 shadow-lg"
                      />
                    </div>
                    {/* Vela 4 - Verde claro */}
                    <div className="bg-gradient-to-b from-[#4ADE80] to-[#309551] rounded-full opacity-80 shadow-lg transform -rotate-3 hover:-rotate-6 transition-transform duration-500">
                      <img
                        src="/banner-4.webp"
                        alt="Vela Verde Claro"
                        className="rounded-xl object-cover w-full h-full transform -rotate-3 hover:-rotate-6 transition-transform duration-500 shadow-lg"
                      />
                    </div>
                  </div>

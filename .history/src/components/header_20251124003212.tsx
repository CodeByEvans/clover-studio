    ...
    <header className="bg-white/95 backdrop-blur-sm border-b border-gray-100 sticky top-0 z-40 px-4 shadow-sm">
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center gap-0 w-full max-w-xl">
            <div className="border border-gray-300 rounded-l-md px-2 bg-white">
              <Select
                value={selectedCollection}
                onValueChange={setSelectedCollection}
              >
                <SelectTrigger className="border-none shadow-none p-0 w-[160px] focus:ring-0 focus:ring-offset-0">
            ...
            <button className="border border-gray-300 rounded-r-md px-3 bg-gray-50 hover:bg-gray-100">

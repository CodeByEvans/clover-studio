      ...
      >
        {images.map((src, i) => (
          <SwiperSlide key={i} className="cursor-pointer">
            <div className="border-2 border-transparent rounded-md overflow-hidden transition-all duration-200 hover:border-gray-300 swiper-slide-thumb-active:border-blue-500">
              <Image
                src={src}
                width={50}
                height={50}

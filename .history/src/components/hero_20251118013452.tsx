...
export const Hero = ({ products }: HeroProps) => {
  ...
  return (
    <section className="min-h-screen bg-gradient-to-br from-[#BEE8CC]/5 via-[#FEFCF9] to-[#FDE68A]/8 overflow-hidden relative flex flex-col items-center justify-center px-8 md:px-12 lg:px-20 gap-8">

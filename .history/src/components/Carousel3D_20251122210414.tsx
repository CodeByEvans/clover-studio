                ...
                >
                  ...
                  <div className="relative p-5 space-y-2.5">
                    ...
                    <div className="flex items-start justify-between gap-2 text-center">
                      <h3 className="text-xl font-bold text-foreground mx-auto">
                        {product.title}
                      </h3>
                    </div>
      ...
      {isMobile && (
        <div className="flex flex-col gap-4">
          <Link href="/colecciones">
            <Button variant="default" size="lg" className="mx-auto block w-40">
              Ver colecciones
            </Button>
          </Link>
          <Link
          ...
          >
            <Button variant="secondary" size="lg" className="mx-auto block">
              Contacto
            </Button>
          </Link>
        </div>

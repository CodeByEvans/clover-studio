          ...
          <div className="space-y-8">
            ...
            <div>
              <h1 className="text-5xl md:text-6xl xl:text-7xl font-bold text-gray-900 leading-tight mb-6">
                ...
                <span className="block text-transparent bg-gradient-to-r from-[#B91C1C] to-[#8B1E3F] bg-clip-text">
                  iluminan
                </span>
                grandes momentos
              </h1>
            ...
            <p className="text-xl md:text-2xl text-gray-600 leading-relaxed max-w-lg">
              ...
              <span className="text-[#ae0006] font-semibold">
                {" "}
            ...
            <div className="space-y-4">
              <div className="flex flex-col sm:flex-row gap-3 max-w-md">
                ...
                <button className="group relative overflow-hidden whitespace-nowrap">
                  <div className="absolute inset-0  opacity-90 group-hover:opacity-100 transition-opacity duration-300"></div>
                  <div className="relative bg-[#39a459] text-white px-8 py-4 rounded-full font-semibold text-lg transition-all duration-300 shadow-lg transform group-hover:-translate-y-1 group-hover:shadow-xl flex items-center justify-center gap-2">
                    Lista VIP
              ...
              <p className="text-sm text-gray-500 max-w-md">
                <span className="font-semibold text-[#ae0006]">
            ...
            <div>
              <button
                ...
                className="group  hover:text-[#8B1E3F] font-medium text-lg transition-all duration-300 flex items-center gap-2 cursor-pointer"
              >

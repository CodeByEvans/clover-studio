...
const reviews = [
  {
    ...
    productImage: "/images/wax-melts-extasis-floral.webp",
  },
  {
    id: 2,
    name: "Anónimo",
    ...
    rating: 5,
    text: "Trato atento y cercano desde el primer momento. La vela personalizada para el evento corporativo fue un éxito total entre mis colegas.",
    productImage: "/images/vela-personalizada-corporativa.webp",
  },
  {
    id: 3,
    name: "Laura G.",
    productName: "Wax-Melts Bosque",
    rating: 5,

          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              <div className="flex flex-col sm:flex-row gap-3 max-w-md">
                <input
                  ...
                  className="flex-1 px-6 py-4 rounded-full border-2 border-gray-200 focus:border-[#F8C8DC] focus:outline-none text-lg transition-all duration-300"
                />
                <button className="group relative overflow-hidden whitespace-nowrap">
                  <div className="absolute inset-0 bg-gradient-to-r from-[#F8C8DC] to-[#D3B5E5] opacity-90 group-hover:opacity-100 transition-opacity duration-300"></div>
                  <div className="relative bg-gradient-to-r from-[#F8C8DC] to-[#D3B5E5] text-white px-8 py-4 rounded-full font-semibold text-lg transition-all duration-300 shadow-lg transform group-hover:-translate-y-1 group-hover:shadow-xl flex items-center justify-center gap-2">
                    Lista VIP
              ...
              <p className="text-sm text-gray-500 max-w-md">
                ...
                <span className="font-semibold text-[#F8C8DC]">
                  {" "}
                  20% de descuento
                </span>{" "}
            ...
            <div>
              <button
                ...
                className="group text-[#8B1E3F] hover:text-[#F8C8DC] font-medium text-lg transition-all duration-300 flex items-center gap-2"
              >
              ...
              <div className="relative bg-white rounded-3xl shadow-2xl p-8 group-hover:shadow-3xl transition-all duration-500 border border-gray-100">
                ...
                <div className="aspect-square bg-gradient-to-br from-[#FEFCF9] to-[#F9F7F3] rounded-2xl flex items-center justify-center relative overflow-hidden">
                  ...
                  <div className="absolute inset-4 grid grid-cols-2 gap-4">
                    {/* Vela 1 */}
                    <div className="bg-gradient-to-b from-[#F8C8DC] to-[#f5b8d1] rounded-full opacity-80 shadow-lg transform rotate-3 hover:rotate-6 transition-transform duration-500"></div>
                    {/* Vela 2 */}
                    <div className="bg-gradient-to-b from-[#BEE8CC] to-[#a8d4b8] rounded-full opacity-80 shadow-lg transform -rotate-2 hover:-rotate-6 transition-transform duration-500"></div>
                    {/* Vela 3 */}
                    <div className="bg-gradient-to-b from-[#FDE68A] to-[#fcd34d] rounded-full opacity-80 shadow-lg transform rotate-1 hover:rotate-4 transition-transform duration-500"></div>
                    {/* Vela 4 */}
                    <div className="bg-gradient-to-b from-[#D3B5E5] to-[#c69bd1] rounded-full opacity-80 shadow-lg transform -rotate-3 hover:-rotate-6 transition-transform duration-500"></div>
                  </div>

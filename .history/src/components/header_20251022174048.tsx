        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="hidden lg:block">
              {/* Botón CTA */}
              <Link
                href="https://wa.me/34691453544" // WhatsApp directo a España +34
                target="_blank"
                rel="noopener noreferrer"
                className="bg-[#ae0006] text-white px-6 py-3 rounded-full font-semibold shadow-md hover:bg-[#d1323d] transition-colors duration-300"
              >
                Contáctanos
              </Link>
            </div>

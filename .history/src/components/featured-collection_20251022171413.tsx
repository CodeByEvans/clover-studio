...
const featuredProducts = [
  ...
  },
  {
    ...
    name: "Corazón Rosado",
    description:
      "Wax-melt en forma de corazón rosa, con aroma dulce y floral, perfecto para derretir en tu quemador y llenar tu hogar de un toque romántico y delicado.",
    image: "/images/corazon-rosado.webp",
    link: "#",
  },
];
